...
export default function ProjectItem({ project, onSendData }: { project: project, onSendData: (project: project) => void }) {
    ...
    return (
        <div className="flex flex-row gap-4 p-4 justify-around bg-white rounded-lg text-black border-1 hover:shadow-md transition-all duration-300 ease-in-out">
            ...
            <div className="flex flex-row gap-2 justify-end w-full">
                <button onClick={() => onSendData(project)} className="bg-blue-500 hover:bg-blue-700 text-white p-2 rounded-sm">Edit</button>
